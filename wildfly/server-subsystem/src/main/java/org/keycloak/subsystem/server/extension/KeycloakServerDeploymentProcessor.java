...
public class KeycloakServerDeploymentProcessor implements DeploymentUnitProcessor {
    ...
    private static final String[] CACHES = new String[] {
        "realms", "users","sessions","authenticationSessions","offlineSessions","clientSessions","offlineClientSessions","loginFailures","work","authorization","keys","actionTokens","OIDCDiscovery"
    };
