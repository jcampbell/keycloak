...
public interface OIDCDiscoveryRepresentationProvider extends Provider {
    /**
     * Get OIDCConfigurationRepresentation for a given provider
     *
     * @param providerId
     * @return
     */
    OIDCConfigurationRepresentation getOIDCConfigurationRepresentation(String issuer) throws IOException;
